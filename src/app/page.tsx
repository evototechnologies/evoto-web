      ...
      <section className="py-28 bg-[var(--c-surface)] border-t border-[var(--c-border)] relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-10 py-4 bg-[var(--c-accent)] text-[#0A0A0A] text-sm font-medium tracking-wide hover:bg-[var(--c-accent-h)] transition-all duration-300"
            >
